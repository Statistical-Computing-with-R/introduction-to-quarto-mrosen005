...
*This dataset investigates the effect of supplements on tooth growth in guinea pigs.*
...
#| layout-ncol: 2
#| fig-cap:
#|   - "Supplement and Length of Teeth"
#|   - "Dose of Supplement and Length of Teeth"
...
## T-test Comparing Tooth Length Between the Two Supplement Methods

```{r}
data("ToothGrowth")
ttest_supp_len <- t.test(len ~ supp, data = ToothGrowth, var.equal = FALSE, alternative = "two.sided")
print(ttest_supp_len)
```
1) With a p-value of 0.06063, at a significance level of 0.05, we fail to reject the null hypothesis. There is not sufficient evidence of a difference in mean tooth lengths in guinea pigs between guinea pigs who received supplements via orange juice and mean tooth lengths in guinea pigs who received supplements via ascorbic acid. 
2) The 95% confidence interval for the difference in means between guinea pigs who received supplements via orange juice and mean tooth lengths in guinea pigs who received supplements via ascorbic acid is -0.1710156 and 7.5710156. This means that we are 95% confident that the true difference in mean tooth lengths between guinea pigs who received supplements via orange juice and mean tooth lengths in guinea pigs who received supplements via ascorbic acid is between -0.17 mm and 7.57 mm. 
